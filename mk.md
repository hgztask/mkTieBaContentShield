...
对贴吧(tieba.baidu.com)部分页面内容进行屏蔽处理，主要作用域为帖子列表、评论区和热议榜等
评论处鼠标移入可显示屏蔽按钮，点击可根据需求添加类型屏蔽。

帖子列表和评论区将鼠标放上去时，将显示屏蔽按钮，点击可按需类型屏蔽该用户。

安装本脚本优先拓展为脚本猫其次篡改猴，其他不建议。
...
奔跑中的奶酪版本的便携版本edge或chrome

    地址https://www.runningcheese.com/edge
...
5. 如果有什么问题，欢迎提issue或前往作者交流群或b站个人主页上反馈
6. 该如还有未补充的，待后续完善描述
