...
export default {
  data() {
    return {
      outputInfoArr: [] as outputInfoType[],
    }
  },
  methods: {
    clearInfoBut() {
    ...
    lookDataBut(row: outputInfoType) {
      console.log(row)
    },
    addOutInfo(data: outputInfoType) {
  ...
  created() {
    eventEmitter.on('event:print-msg', (msgData: string | outputInfoType) => {
